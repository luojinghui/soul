...
import { MusicInfo, MusicBarPosition, MusicBarVisible, MusicBarMiniMode, MusicBarMagneticLeft } from '@/store';
import { PlayCircleFilled, PauseCircleFilled, CloseOutlined } from '@ant-design/icons';
      ...
      >
        <div className="soul_player_content">
          <div className="player_operate">
            <div className="toggle event" data-type="toggle" onClick={toggleMode}>
              <span className={`iconfont ${toggleClassName} toggle-icon`}></span>
            </div>

            <div
              className={`cover mr ${miniMode ? 'soul_player_hidden' : 'soul_player_show_flex'}`}
              onClick={onClickCover}
            >
              <img draggable={false} className={pauseState ? 'rotate-pause' : ''} src={musicInfo.cover} alt="" />
            </div>

            <div
              ref={musicTitleRef}
              id="soul_music_title"
              className={`title mr ${miniMode ? 'soul_player_hidden' : 'soul_player_show_flex'}`}
            >
            ...
            {pauseState ? (
              <PlayCircleFilled className="btn event mr" data-type="play" onClick={play} />
            ) : (
              <PauseCircleFilled className="btn event mr" data-type="pause" onClick={pause} />
            )}

            <CloseOutlined className="btn event close" data-type="close" onClick={onClose} />
          </div>
